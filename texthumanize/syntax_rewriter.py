...
_RU_NOMINALIZATION: dict[str, str] = {
    ...
    "рассмотрение": "рассмотреть",
    "достижение": "достичь",
    "привлечение": "привлечь",
    "выполнение": "выполнить",
    "исследование": "исследовать",
    "разработка": "разработать",
    "подготовка": "подготовить",
    "оценка": "оценить",
    "проверка": "проверить",
    "обработка": "обработать",
    "поддержка": "поддержать",
    "переработка": "переработать",
    "доработка": "доработать",
    "наладка": "наладить",
    "настройка": "настроить",
    "корректировка": "скорректировать",
    "регулировка": "отрегулировать",
    "координация": "координировать",
    "демонстрация": "продемонстрировать",
    "интеграция": "интегрировать",
    "генерация": "генерировать",
    "документирование": "документировать",
    "тестирование": "тестировать",
    "мониторинг": "мониторить",
    ...
    "производство": "произвести",
    "внедрение": "внедрить",
    "устранение": "устранить",
    "приобретение": "приобрести",
    "осуществление": "осуществить",
    ...
    "ускорение": "ускорить",
    "замедление": "замедлить",
    "упрощение": "упростить",
    "усложнение": "усложнить",
}

# ─── UK Nominalization → Verb ───────────────────────────────
_UK_NOMINALIZATION: dict[str, str] = {
    "реалізація": "реалізувати",
    "імплементація": "імплементувати",
    "оптимізація": "оптимізувати",
    "організація": "організувати",
    "модернізація": "модернізувати",
    "класифікація": "класифікувати",
    "модифікація": "модифікувати",
    "верифікація": "верифікувати",
    "трансформація": "трансформувати",
    "формування": "сформувати",
    "визначення": "визначити",
    "створення": "створити",
    "прийняття": "прийняти",
    "управління": "управляти",
    "забезпечення": "забезпечити",
    "застосування": "застосувати",
    "проведення": "провести",
    "використання": "використати",
    ...
    "розробка": "розробити",
    "підготовка": "підготувати",
    "оцінка": "оцінити",
    "перевірка": "перевірити",
    "обробка": "обробити",
    "підтримка": "підтримати",
    "переробка": "переробити",
    "доробка": "доробити",
    "налагодження": "налагодити",
    "налаштування": "налаштувати",
    "коригування": "скоригувати",
    "регулювання": "відрегулювати",
    "координація": "координувати",
    "демонстрація": "продемонструвати",
    "інтеграція": "інтегрувати",
    "генерація": "згенерувати",
    "документування": "задокументувати",
    "тестування": "протестувати",
    "моніторинг": "моніторити",
    "аналіз": "проаналізувати",
    "синтез": "синтезувати",
    "контроль": "контролювати",
    "облік": "обліковувати",
    "розрахунок": "розрахувати",
    "розвиток": "розвинути",
    "поліпшення": "поліпшити",
    "вимірювання": "виміряти",
    "заміщення": "замістити",
    "розподіл": "розподілити",
    "виробництво": "виробити",
    "впровадження": "впровадити",
    "усунення": "усунути",
    "придбання": "придбати",
    "здійснення": "здійснити",
    "розміщення": "розмістити",
    "переміщення": "перемістити",
    "підвищення": "підвищити",
    "зниження": "знизити",
    "скорочення": "скоротити",
    "збільшення": "збільшити",
    "зменшення": "зменшити",
    "прискорення": "прискорити",
    "уповільнення": "уповільнити",
    "спрощення": "спростити",
    "ускладнення": "ускладнити",
}
...
class SyntaxRewriter:
    ...
    def _nom_generic(
        ...
        """Nominalization for RU/UK — convert noun phrases to verb forms."""
        if self._lang == "ru":
            return self._nom_ru(sentence)
        if self._lang == "uk":
            return self._nom_uk(sentence)
        return None
